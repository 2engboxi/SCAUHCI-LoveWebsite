				...
				<tr>
					...
					<table width="100%">
						...
						<tr>
							...
							<td>
								<img src="/webdemo/Administrator/photo/mail.png" width="120">
							</td>
							<td>
								<img src="/webdemo/Administrator/photo/mailing.png" width="120">
							</td>			
						</tr>
						<tr>
							<td>
							...
							<td valign="top">
								<form name="mailForm" method="post" action="ShowSendEmail.jsp">
								<input type="submit" name="Submit" value="personal" style="width:120;height=40">			
							</td>
							<td valign="top">
								<input type="submit" name="Submit" value="all" style="width:120;height=40">
							    </form>
							</td>
