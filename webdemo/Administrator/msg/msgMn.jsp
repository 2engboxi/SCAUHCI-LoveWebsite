	...
	<body bottommargin="30" topmargin="30" leftmargin="0" rightmargin="0" marginheight="0" marginwidth="0" bgcolor="#808080" vlink="#000000" link="#000000" alink="#000000">
		<table align="center" cellspacing="0" cellspading="0" bgcolor="#D3D3D3" frame=vsides>
			<tbody>
				...
				<tr>
					<td colspan="2">
						<a href="/webdemo/Administrator/index.jsp">返回首页</a>&nbsp;&nbsp;&nbsp;<a href=/webdemo/Administrator/query/users.jsp>用户管理</a>&nbsp;&nbsp;&nbsp;<a href=/webdemo/Administrator/msg/msgMn.jsp>信息管理</a>&nbsp;&nbsp;&nbsp;<a href>聊天管理</a>&nbsp;&nbsp;&nbsp;<a href="/webdemo/sendE-mail/E-mailSurface.jsp">邮箱管理</a>
					</td>
				...
				<tr>
					<td width="20%"><font face="楷书"><u>当前位置：首页>信息管理</u></font></td>
					
					<td rowspan="3" width="65%" height="500" valign="top">
					
						<table width="100%">
							<tr>
								<td colspan="4" align="4"><h1>信息管理</h1></td>
							</tr>
							<tr>
								<td colspan="4"><HR style="FILTER: alpha(opacity=80,finishopacity=0,style=3)" width="100%" color=#000000 SIZE=3></hr></td>
							</tr>
							<tr>
								<td width="150" height="200">
							    </td>
								<td valign="bottom">
									<input type="image" src="/webdemo/Administrator/photo/news.png" >	
								</td>
								<td valign="bottom">
									<input type="image" src="/webdemo/Administrator/photo/usermessage.png" >	
								</td>
								<td valign="bottom">
									<input type="image" src="/webdemo/Administrator/photo/person.png" >	
								</td>
							</tr>
							<tr>
								<td>
								...
								<form name="queryForm" method="post" action="deal.jsp">
									<input type="button" name="submit"  value="新闻发布" style="font-size:1em;font-weight:500;background:Images(/webdemo/Administrator/photo/userinfo.png);width:120; height:45" onclick="news_upload()">
								</form>
								</td>
								<td>
								<form name="queryForm" method="post" action="/webdemo/Administrator/queryUserUpload/get_news_info.jsp">
									<input type="button" name="submit"  value="信息审核" style="font-size:1em;font-weight:500;background:Images(/webdemo/Administrator/photo/userinfo.png);width:120; height:45" onclick="upload_query()">
								</form>
								</td>
								<td>
								<form name="queryForm" method="post" action="deal.jsp">
									<input type="button" name="button"  value="爱心人物" style="font-size:1em;font-weight:500;background:Images(/webdemo/Administrator/photo/userinfo.png);width:120; height:45" onclick="character_query()">
								</form>
								</td>
							</tr>
							<tr>
